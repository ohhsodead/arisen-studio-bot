...
class Bot(discord.AutoShardedBot):
    ...
    async def on_ready(self) -> None:
        ...
        await self.change_presence(activity=discord.Game(name="/search | arisen.studio"), status=discord.Status.online)
    ...
    async def on_application_command_error(
        ...
        """
        await ctx.respond(f"An error occurred: {exception}")
